...
const metalData: Record<string, MetalData> = {
  ...
  "c103-alloy-powder": {
    ...
    heroImage: c103Hero,
    description:
      "High-temperature niobium-based superalloy powder for rocket propulsion, hypersonic systems, and extreme-environment aerospace applications. Nb-10Hf-1Ti composition engineered for service temperatures exceeding 1400°C.",
    applications: [
      "Rocket engine nozzles and thrust chambers",
      "Hypersonic vehicle leading edges",
      "Liquid rocket propulsion components",
      "High-temperature aerospace structures",
      "Additive manufacturing",
      "PM-HIP processing",
    ],
    seoContent: [
      "Metal Powder Supply is one of the few US-based C103 alloy powder suppliers with domestic production capability. Our C103 powder is produced via EIGA (Electrode Induction Melting Gas Atomization) to deliver the spherical morphology and low oxygen content required for aerospace-grade additive manufacturing and PM-HIP processing.",
      "Our Nb-10Hf-1Ti powder meets the demanding specifications for rocket propulsion and hypersonic applications. Full material traceability, lot-level chemical analysis, and particle size distribution certification on every shipment. ITAR-compliant supply chain from atomization through delivery.",
      "Contact our team for C103 powder sourcing, custom particle size distributions, and technical guidance on processing parameters for your specific application.",
    ],
    keywords: [
      "C103 alloy powder supplier",
      "Nb-10Hf-1Ti powder",
      "C103 niobium superalloy",
      "C103 powder additive manufacturing",
      "C103 rocket propulsion powder",
      "US C103 alloy powder supplier",
    ],
  },
